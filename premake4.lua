...
solution "NymphGameEngine"
  ...
  project "NymphGameEngine"
    ...
    configuration "MacDebug"
      ...
      links {  "glfw", "png", "z", "OpenGL.framework", "glew", "IL", "tmxparser", "chaiscript" }
      defines { "DEBUG" }
      flags { "Symbols" }
      targetextension ".out"
    ...
    configuration "MacRelease"
      ...
      links {  "glfw", "png", "z", "OpenGL.framework", "glew", "IL", "tmxparser", "chaiscript", "`freetype-config --cflags`", "`freetype-config --libs`" }
      defines { "NDEBUG" }
      flags { "Optimize" }
      targetextension ".out"
    ...
    configuration "LinuxDebug"
      ...
      links {  "glew", "glfw", "png", "z", "GL", "IL", "tmxparser", "dl", "chaiscript_stdlib-6.0.0" }
      defines { "DEBUG" }
      flags { "Symbols" }
      targetextension ".out"
    ...
    configuration "WindowsDebug"
      ...
      links { "glfw3", "gdi32", "glew32s", "opengl32", "png", "z", "DevIL", "chaiscript_stdlib-5.8.5" }
